...
function Header() {
  ...
  <div className="hero-content flex-col lg:flex-row justify-around  w-full">
    <div className="text-center lg:text-left  w-full space-y-4">
      ...
      <h1 className="text-5xl font-bold pb-16">your bookshelf</h1>
      <button className="btn bg-green-500 font-bold text-xl mt-10 text-white"><Link to={'/listedBook'}>View the List</Link></button>
    </div>
